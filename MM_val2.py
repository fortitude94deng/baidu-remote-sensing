...
在验证集上分析训练得到的单模型  测试se_resnet50 se_resnext50_32x4d
'''
import os
import csv
import h5py
...
def GeResult():
    ...
    # construct network
    epoch = 18
    net = MultiModalNet1('multiscale_se_resnext_HR', 'DPN26', 0.5)
...
#        net = nn.DataParallel(net)
    ...
    net.to(device)
    net.load_state_dict(torch.load('/home/dell/Desktop/2019BaiduXJTU/weights/multiscale_se_resnext_HR_se_resnext50_32x4d_resample_pretrained_80w_1/BDXJTU2019_SGD_' + str(epoch) + '.pth'))
