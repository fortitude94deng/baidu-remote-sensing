...
parser.add_argument('--basenet', default = 'multiscale_resnet', type = str)
...
def main():
    ...
    if args.basenet == 'se_resnet152':
    ...
    elif  args.basenet == 'multiscale_resnet':
        model = MultiModalNet1('multiscale_resnet', 'DPN26', 0.5) 
        ...
        model = oct_resnet101()    
        #net = Networktorch.nn.DataParallel(Network, device_ids=[0])
#    print("load pretrained model from /home/dell/Desktop/2019BaiduXJTU/weights/se_resnet152_se_resnext50_32x4d_resample_pretrained_80w_1/BDXJTU2019_SGD_6.pth")
#    pre='/home/dell/Desktop/2019BaiduXJTU/weights/se_resnet152_se_resnext50_32x4d_resample_pretrained_80w_1/BDXJTU2019_SGD_6.pth'
...
#        model = nn.DataParallel(model)
    ...
    Dataloader_train = data.DataLoader(Dataset_train, 32, 
                                 num_workers = 16,
